...
<div class="panel-group" id="framework-accordion">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="noCrossRef accordion-toggle" data-toggle="collapse" data-parent="#framework-accordion" href="#collapseOne">Click here for OWASP (Open Worldwide Application Security Project)</a>
            </h4>
        </div>
...
Considerations for testing firmware and IoT applications.
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="noCrossRef accordion-toggle" data-toggle="collapse" data-parent="#framework-accordion" href="#collapseTwo">Click here for MITRE</a>
            </h4>
        </div>
...
[https://cwe.mitre.org/data/definitions/1425.html](https://cwe.mitre.org/data/definitions/1425.html)
...
The Atomic Red Team have a similar offering here: [https://github.com/redcanaryco/atomic-red-team](https://github.com/redcanaryco/atomic-red-team)

With a comparison here: [https://redcanary.com/blog/testing-and-validation/atomic-red-team/comparing-red-team-platforms/](https://redcanary.com/blog/testing-and-validation/atomic-red-team/comparing-red-team-platforms/)
...
[Mitre Atlas Navigator](https://mitre-atlas.github.io/atlas-navigator/#layerURL=https://raw.githubusercontent.com/mitre-atlas/atlas-navigator-data/main/dist/default-navigator-layers/atlas_layer_matrix.json)
...
MITRE ATLAS is a knowledge base of adversary tactics, techniques, and case studies for artificial intelligence (AI) systems. It provides a comprehensive resource for understanding and safeguarding AI systems.
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="noCrossRef accordion-toggle" data-toggle="collapse" data-parent="#framework-accordion" href="#collapseThree">Click here for NIST (National Institute of Standards and Technology)</a>
            </h4>
        </div>
...
[https://www.nist.gov/cyberframework](https://www.nist.gov/cyberframework)
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="noCrossRef accordion-toggle" data-toggle="collapse" data-parent="#framework-accordion" href="#collapseFour">Click here for CIS (Centre of Internet Security)</a>
            </h4>
        </div>
...
Tools to help a company map and comply with industry regulations.
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="noCrossRef accordion-toggle" data-toggle="collapse" data-parent="#framework-accordion" href="#collapseFive">Click here for TIBER-EU</a>
            </h4>
        </div>
